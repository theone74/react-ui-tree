...
class UITreeNode extends Component {
  ...
  handleMouseDown = e => {
    ...
    if (this.props.onDragStart && this.props.index.node.movable) {
      this.props.onDragStart(nodeId, dom, e);
    }
    else if (this.props.onNoDrag && !this.props.index.node.movable) {
      this.props.onNoDrag(nodeId, dom, e);
    }
  };
}
